...
public:
    ...
    void run()
    {
            ...
            else if (n >= 300 && n <= 330){zmp_ref = (0.01/30)*n - 0.1;} // variar desde 0.01 a 0.09
...
*/
        ...
        cout << endl << "La offset IMU es: " << offs_x_j << endl;
    ...
    {
        if(n==1){
            fprintf(fp,"Time,angle_ref,zmp_ref,zmp_ft,Xzmp_imu,ka,ba,ddx_rob,ddz_rob,offs_x_j,iter");
        }
