...
public:
    ...
    void run()
    {
        ...
        if (m>=300){
            ...
            if (n <= 300){ref = 0.0;}
            else if (n >= 300 && n <= 330){ref = (0.03/30)*n - 0.3;}
            else {ref = ref;}
    ...
    void angleComp(){
        ...
        _angle_ref = -(asin((_eval_x._zmp_error)/L) * 180 / pi);
        return;
    }
...
*/
    ...
    void evaluateModel(){
        ...
        /*f(x) = 0.008525*x^2 + 0.0007298*x + 1.888e-05; // donde x = _eval_x._zmp_ref
                Coefficients (with 95% confidence bounds):
                p1 =    0.008525  (0.001754, 0.0153)
                p2 =   0.0007298  (3.399e-05, 0.001426)
                p3 =   1.888e-05  (4.145e-06, 3.362e-05)
                */
...
//        velLeftLeg->velocityMove(4, -vel);
    ...
    void printData()
    {
        ...
        cout << endl << "El angulo x es: " << angle_x << endl;
        cout << endl << "El ZMP FT es: " << X << endl;
        cout << endl << "La ZMP ref es: " << ref << endl;
    ...
    void saveInFileCsv()
    {
        if(n==1){
            ...
            fprintf(fp,",ZMPref_mm,eval_x.zmp_ref_mm,evalx.y_mm,angle_ref,zmp_ref,iteraciones");
        }
