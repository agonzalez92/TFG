%% Data (measures in m) - 17/10/2017
%El programa consiste en coger los 100 ultimos valores de los Zmp-FT y
%hacer la media de los 3 test, y luego hacer la media de esas 3 medias,
%sacando los valores del valor media de este .m
%El valor del ref7 en la media me lo he inventado porque me he dado cuenta
%que en el archivo media.csv el valor es muy alto y saldria mal la grafica
