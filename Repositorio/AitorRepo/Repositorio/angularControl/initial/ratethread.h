...
//        velLeftLeg->velocityMove(4, -vel);
    ...
    void printData()
    {
        ...
        //cout << endl << "El angulo es: " << _angulo << endl;
        cout << endl << "El angulo es: " << angle_x << endl;
        cout << "ZMP_Error_Loli = ("<<_eval_x._zmp_error << ") [mm]" << endl;
        cout << endl << "El angulo2 es: " << _angulo2 << endl;
    ...
    void saveInFileCsv()
    {
        if(n==1){
            ...
            fprintf(fp,",evalx.y,eval_x.zmp_error,eval_x.zmp_ref,eval_x._u,eval_x._x1[0],eval_x._x2[0],angle_x");
        }
